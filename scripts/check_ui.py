...
def static_checks() -> None:
    ...
    check("made with" in footer, "the footer is missing the 'made with' credit")
    check("CloudTeam" in footer, "the footer is missing the CloudTeam credit")
    check(
        "❤" in footer or "iptt-heart" in footer,
        "the footer credit is missing the heart symbol",
    )
...
def live_checks() -> bool:
    ...
    for path in PAGES:
        ...
        check("made with" in page, f"{path} footer is missing the 'made with' credit")
